    ...
    const getScoreInterpretation = (score: number) => {
        if (score <= 4) {
            ...
            return {
                ...
                description: 'Anda menunjukkan tanda-tanda depresi sedang. Pertimbangkan untuk berkonsultasi dengan nomor di bawah ini.'
            }
        } else if (score <= 19) {
            return {
                level: 'Sedang Berat',
                ...
                description: 'Anda menunjukkan tanda-tanda depresi sedang berat. Pertimbangkan untuk menghubungi nomor di bawah ini.'
            }
        }
        else {
            return {
                ...
                description: 'Anda menunjukkan tanda-tanda depresi berat. Segera hubungi nomor di bawah ini.'
            }
        }
    }
