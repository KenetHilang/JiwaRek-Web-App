    ...
    return (
        <div className="mx-auto flex flex-col justify-center items-center min-h-screen text-center pt-10 bg-gradient-to-br from-blue-50 to-indigo-100 md:px-0 px-4">
            ...
            <AnimatedContent delay={5.5}>
                ...
                <button className="mt-4 px-6 py-2 bg-gray-200 text-black rounded-md hover:bg-gray-300 hover:scale-105 transition-transform duration-300 hover:cursor-pointer">
                    Baca Materi
                </button>
            </AnimatedContent>
